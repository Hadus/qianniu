...
export function dealData(mock_live_detail) {
  var list = {
      ...
      zhuanHuaChengJiao: [
          {
              ...
              name1: "商品点击率",
              zhuanhualv1: (mock_live_detail.ipvUvRate * 100).toFixed(2) + getRandom(1, 20)+"%",
              name2: "非粉丝商品点击率",
              zhuanhualv2: getRandom(1, 50)+"%"
          },
          {
              ...
              name1: "成交转化率",
              zhuanhualv1:  (mock_live_detail.payByrRate * 100 ).toFixed(2) + getRandom(1, 50)+"%",
              name2: "非粉丝成交转化率",
              zhuanhualv2: getRandom(1, 50)+"%",
          },
          {
              ...
              name1: "成交人数",
              zhuanhualv1: mock_live_detail.payBuyerCnt + getRandom(1, 100),
              name2: "非粉丝成交人数占比",
              zhuanhualv2: getRandom(1, 50)+"%",
          },
          {
      ...
      zuiGaoNum: mock_live_detail. lookUv +  1000,
      zuiGaoJiner: mock_live_detail.payAmt + 100,
      ...
      tableData: [{
          ...
          peopleNum: getRandom(1, 100),
          clickNum: getRandom(1, 100),
          buyNum: getRandom(1, 100),
          order: getRandom(1, 10),
          mony: getRandom(1, 10000),
          ...
          peopleNum: getRandom(1, 100),
          clickNum: getRandom(1, 100) + 1,
          buyNum: getRandom(1, 100) + 1,
          order: getRandom(1, 10) + 1,
          mony: getRandom(1, 10000) + 1,
      ...
      zhiBoYu: [{
          name: "观看人数",
          Number: mock_live_detail.lookPv + getRandom(1, 100),
      },
      {
          name: "人数占比",
      ...
      {
          name: "人均时长",
          Number: mock_live_detail.lookTimePu +  getRandom(1, 100),
      },
      {
          name: "成交金额",
          Number: mock_live_detail.payAmt +  getRandom(1, 1000),
      }],
      dianpuyu: [{
          name: "观看人数",
          Number: mock_live_detail.lookPv +  getRandom(1, 1000),
      },
      {
          name: "人数占比",
          Number: getRandom(1, 50)+"%",
      ...
      {
          name: "人均时长",
          Number: mock_live_detail.lookTimePu +  getRandom(1, 1000),
      },
      {
          name: "成交金额",
          Number: mock_live_detail.payAmt + getRandom(1, 1000),
