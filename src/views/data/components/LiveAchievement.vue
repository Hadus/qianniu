  ...
  <div class="live-achievement-container">
        ...
        <div class="user-info-box">
          <div class="user-info">
            <img
              alt="用户头像"
              class="user-avatar"
              src="@/assets/img/data/userAvatar.png"
            />
            <div class="ml20">
              <p>亲</p>
            ...
            <div class="rank-item">
              ...
              <div class="rank-item-content">
                ...
                <i
                  ...
                  style="color: #00a854; margin-left: 5px"
                ></i>
              </div>
            </div>
            <div class="rank-item">
          ...
          <div class="optimization-box mt10">
            <div class="mb10" style="position: relative">
              ...
              <span class="optimization-text"
                >近7天场均有效开播时长260，相比同级同类主播平均水平312，低17%</span
              >
            ...
            <div class="mb10" style="position: relative">
              ...
              >
              <span class="optimization-text"
                >近7天场均有效开播场次1，相比同级同类主播平均水平1，低2%</span
              >
              <span class="view-plan">查看锦囊</span>
            </div>
            <div style="position: relative">
              ...
              >
              <span class="optimization-text"
                >近7天场均有效观看时长194，相比同级同类主播平均水平382，低49%</span
              >
              <span class="view-plan">查看锦囊</span>
            </div>
          </div>
            ...
            <div>
              <span class="notice-icon">
                <svg
                  ...
                  height="20"
                  fill="rgb(32, 98, 230)"
                  data-spm-anchor-id="a21ag.21587146.0.i9.5693410cZqUUNv"
                >
                  <path
                  ...
                  ></path>
                  <path
                    d="M208.857 356.891h32.992v310.245h-32.992V356.891z"
                  ></path>
                  <path
    ...
    <div class="tabs">
      <div
        ...
        @click="handleSelectLiveType('livePerformance')"
      >
        直播间业绩表现
      </div>
      <div
        class="tab-item"
        :class="{ active: myLiveActive }"
        @click="handleSelectLiveType('myLive')"
      >
        我的直播列表
      </div>
    </div>
